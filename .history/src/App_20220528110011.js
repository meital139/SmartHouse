...
function App() {
  ...
  const [rooms,setRooms] =  useState([{roomType:'saloon', roomName: 'salon1' , roomColor: 'darkturquoise',roomProducts: [{roomProduct:'boiler',productStatus:''}]}]);
...
//פונקציה להוספת חדרים
  const addNewRoomToArr = (newRoomType,newRoomName,newRoomColor,newRoomProduct)=>{
    let tempRoom ={
      roomType: newRoomType,
      roomName: newRoomName,
      roomColor: newRoomColor,
      roomProducts: [{roomProduct:newRoomProduct,productStatus:false}]
    }
