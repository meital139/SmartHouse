...
function App() {
  ...
  const [rooms,setRooms] =  useState([{roomType:'saloon', roomName: 'salon1' , roomColor: 'darkturquoise',roomProducts: [{roomProduct:''}]}]);
...
const addNewProductToArr = (newRoomProduct)=>{
  ...
  setProducts(...[rooms[chosenRoom].roomProducts,(tempProduct)]);
    ...
    {/* //האם פה לשים תפריט ניווט? לשאול את אוהד */}
      <Menu/>
        <Routes>
          ...
          <Route path='/add-Product' element={<AddProduct addProds={addNewProductToArr} temp={rooms[chosenRoom]}/>}/>
