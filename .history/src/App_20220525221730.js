...
const addNewProductToArr = (roomProduct)=>{
  let tempProduct ={
    ...
    {/* //האם פה לשים תפריט ניווט? לשאול את אוהד */}
      <Menu/>
        <Routes>
          ...
          <Route path='/add-Product' element={<AddProduct addProds={addNewProductToArr} roomProduct={roomProduct} temp={rooms[chosenRoom]} roomType={rooms.roomType} products={rooms.roomProducts}/>}/>
