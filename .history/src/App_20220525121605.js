    ...
    {/* //האם פה לשים תפריט ניווט? לשאול את אוהד */}
      <Menu/>
        <Routes>
          ...
          <Route path='/add-Product' element={<AddProduct addProds={addNewProductToArr} tempProduct={tempProduct} temp={rooms[chosenRoom]} products={rooms[chosenRoom].roomProducts} roomType={rooms.roomType}/>}/>
