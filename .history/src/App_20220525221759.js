    ...
    {/* //האם פה לשים תפריט ניווט? לשאול את אוהד */}
      <Menu/>
        <Routes>
          ...
          <Route path='/add-Product' element={<AddProduct addProds={addNewProductToArr} roomProduct={newRoomProduct} temp={rooms[chosenRoom]} roomType={rooms.roomType} products={rooms.roomProducts}/>}/>
