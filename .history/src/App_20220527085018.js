    ...
    {/* //האם פה לשים תפריט ניווט? לשאול את אוהד */}
      <Menu/>
        <Routes>
          ...
          <Route path='/roomDetails' element={<RoomDetails temp={rooms[chosenRoom]} showRoom={openRoomDetails} index={rooms.index} roomName={rooms.roomName} roomType={rooms.roomType} roomColor={rooms.roomColor} roomProducts={theRoom.roomProducts}/>}/>
          <Route path='/add-Product' element={<AddProduct addProds={addNewProductToArr}/>}/>
          {/* <Route path='/product' element={<Product product={roomProducts} theRoom={rooms[chosenRoom]}/>}/> */}
