...
export default function AddProduct(props) {
  ...
  // const validProduct=()=>{
        ...
        // if(props.temp.products.isArray('StereoSystem') == true){
    // alert ('ERROR');
    // }
  //   if(props.temp.roomType != ('BathroomToilet') && roomProduct==('Boiler')){
  //     alert ('ERROR');
  //   }
  ...
  return (
    <div>
        <h1>Add Product to Your Room</h1>
            ...
            <Link to='/roomDetails'><button onClick={props.temp.addProds(roomProduct)} id='prodBtn'>Add Product</button></Link>
    </div>
  )
}
