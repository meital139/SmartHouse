...
export default function RoomDetails(props) {
  ...
  return (
    <div>
        ...
        <div id='devicesBlock' >
          <div id='devicesTitle' style={{backgroundImage: URL('https://media.istockphoto.com/photos/smart-house-concept-home-automation-picture-id1172913216?k=20&m=1172913216&s=612x612&w=0&h=U2g3JM4CDugrqpFt5PJMxOLyFEQZzI7v2vuCz58Wt2A=')}}>{props.temp.roomName} room's Devices:</div>
