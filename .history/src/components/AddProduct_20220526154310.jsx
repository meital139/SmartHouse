...
export default function AddProduct(props) {
  ...
  const roomProduct1 = useRef('');


  const validProduct=(roomProduct1)=>{
    console.log(roomProduct1);
    props.addProds(roomProduct1);
    // props.temp.roomProducts.addProds(roomProduct);
    return true
    }
  ...
  return (
    <div>
        ...
        <select ref={roomProduct1} className='selectproduct' id='productTypeSelect' name='product-type-select'>
