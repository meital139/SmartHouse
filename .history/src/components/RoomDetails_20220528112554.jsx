...
export default function RoomDetails(props) {
  ...
  return (
    <div>
        ...
        <div id='prodTitle'>{props.temp.roomName} room's Devices:</div>
        ...
        <Link to='/add-Product'><button id='addProdBtn'>Add device</button></Link>
    </div>
    </div>
  )
}
