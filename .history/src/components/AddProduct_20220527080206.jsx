...
export default function AddProduct(props) {
  ...
  const handleChange = (event) => {
    setRoomProduct(event.target.value)
  } 
  ...
  return (
    <div>
        ...
        {/* <select ref={roomProduct} className='selectproduct' id='productTypeSelect' name='product-type-select'> */}
          ...
          <form>
            <select value={roomProduct} onSubmit={validProduct} id='productTypeSelect' name='product-type-select'>
            ...
            <Link to='/roomDetails'><input type="submit"></input></Link>
          </form >
