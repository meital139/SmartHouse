...
export default function AddProduct(props) {
  ...
  const validProduct=(roomProduct)=>{
    console.log(roomProduct);
    props.temp.roomProducts.push(roomProduct.value);
    return true
      // if(
  ...
  return (
    <div>
        <h1>Add Product to Your Room</h1>
            <select onRef={(element)=>{(element.target.value)}}className='selectproduct' id='productTypeSelect' name='product-type-select'>
